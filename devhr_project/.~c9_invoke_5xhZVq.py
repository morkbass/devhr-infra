...
class DevhrProjectStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        # )
        imageBucket = s3.Bucket(self, "cdk-rekn-imagebucket",versioned=True,removal_policy=RemovalPolicy.DESTROY)#bucket_name="image-bucket-scj")
        ...
        dynamoTable = dynamodb.Table(self, "Table",
    ...
    ## =====================================================================================
        ...
        webBucket = s3.Bucket(self, "web-site-bucket", 
            #bucket_name="website-bucket-scj",
